...
const tasks = (() => {
    ...
    addTask('first Task', 'this is my first todo', new Date('2/28/2023'), 'low',0,0);
    addTask('second Task', 'this is my second todo', new Date('12/16/2022'), 'low',0,1);
    projects.addProject('2ndProject', 1);
    editTask('still first task', 'this is my first todo',new Date('2/28/2023'), 'medium',0,0);
    addTask('third Task', 'this is my 3rd todo', new Date('12/17/2022'), 'high',1,1);
    addTask('Fourth Task', 'this is my 4th todo', new Date('2/18/2023'), 'high',0,2);
